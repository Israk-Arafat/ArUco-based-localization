...
setup(
    ...
    ] + generate_data_files(['launch', 'config', 'urdf']),
    ...
    entry_points={
        'console_scripts': [
            ...
            'map_builder = py_pubsub.map_builder:main',
            'odom_publisher = py_pubsub.odom_publisher:main',
            'simple_navigator = py_pubsub.simple_navigator:main',
            'simple_joint_publisher = py_pubsub.simple_joint_publisher:main',
            'patrol_markers = py_pubsub.patrol_markers:main',
        ],
    },
)
